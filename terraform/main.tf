...
module "web-server" {
  source = "./modules/web-server" # Path to  module
...
# Output the values from the web-server module
output "web_server_outputs" {
  description = "Outputs from the web-server module"
